...
class KukaFRIClient : public KUKA::FRI::LBRClient {
 ...
 private:
  ...
  // The gains are chosen so that it doesn't add energy into the system.
  // Thanks to Johannes Lachner for providing this trick.
  void IIRFilter(const double sample[kNumJoints])
  {
      double ACoef[ numIIRCoeff+1 ] = {
          0.05921059165970496400,
          0.05921059165970496400
      };
      double BCoef[ numIIRCoeff+1 ] = {
